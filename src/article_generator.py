...
- 原文的每个观点、每个细节、每个引用都必须**一字不漏**完整保留
- 原文有N个段落，输出就必须有N个段落
- 原文有N个观点，输出就必须有N个观点
- 原文有500字，输出就**不能少于500字**
- 原文的每个引用、数据、人名、产品名都要完整呈现
- **绝对禁止**使用"详见"、"等"、"包括但不限于"这类缩写词
- **绝对禁止**说"参考来源中有详细内容"这种话 - 必须在正文完整呈现
...
## 正文
（按主题分块，每块有小标题）
**再次强调：完整保留原文所有观点和细节，一字不漏，只改变表达风格**
...
- 示例：「AI Builders 周报 | 🚨供应链警报、🤖Agent自主突破与SaaS范式转移」
- 可在标题中加入emoji增加吸引力

### 导语区
- 2-3句话概括本周要点
- **关键词加粗**：重要人物名、公司名、核心概念要加粗
- 适时加入emoji（如 🚨警示、💡创新、🔥热点）
...
- 重要数据/数字：**加粗**
- 关键术语首次出现：用斜体标注，如「*智能体*（Agent）」
- 每个观点后紧跟来源标记：[1][2]...
- 段落间可适当加入emoji分隔，增加可读性
...
**再次强调：完整保留原文所有内容，只调整排版格式，不做任何精简！关键处加粗、加斜体、加emoji让文章更吸引眼球！**"""
...
7. 使用专门的排版格式：
   ...
   - 导语：关键词加粗，适时加emoji
   - 正文：按序号分节，如 01 🚨供应链安全警报，关键处加粗、加斜体
   - 关键术语首次出现用斜体，如 *智能体*（Agent）
